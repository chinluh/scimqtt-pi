...
int SetString(int nPos, char *&pstName);
int GetDouble(int nPos, double *&pstdata, int& iRows,int& iCols);
int GetDouble2(int nPos, double *&pstdata, int& iRows,int& iCols);
int SetDouble(int nPos, double *&pstdata, int& iRows,int& iCols);
